		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#poorderviewpoorderview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"poorderviewpoorderview-display": {
								"semanticObject": "poorderviewpoorderview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=poorderview.poorderview",
									"url": sap.ui.require.toUrl("poorderview/poorderview")
								}
							}
						}
					}
