		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#poorderpoorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"poorderpoorder-display": {
								"semanticObject": "poorderpoorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=poorder.poorder",
									"url": sap.ui.require.toUrl("poorder/poorder")
								}
							}
						}
					}
