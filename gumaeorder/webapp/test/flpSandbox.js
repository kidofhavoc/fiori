		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#gumaeordergumaeorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gumaeordergumaeorder-display": {
								"semanticObject": "gumaeordergumaeorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gumaeorder.gumaeorder",
									"url": sap.ui.require.toUrl("gumaeorder/gumaeorder")
								}
							}
						}
					}
